        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-4">
                <div className="flex items-end justify-between">
                    ...
                    <div className="flex items-center gap-4 text-[25px]">
                        <div className="flex flex-col gap-1">
                            <Icons name="thumbsUp" />
                            <p className="text-[16px] text-textSecondary opacity-50 font-light">
                                24
                            </p>
                        </div>
                        <div className="flex flex-col gap-1">
                            ...
                            />
                            <p className="text-[16px] text-textSecondary opacity-50 font-light text-blue-500">
                                36
                            </p>
                        </div>
                    </div>
                ...
                <div className="flex flex-col gap-2 bg-bgInput rounded-lg border border-border p-4">
                    ...
                    <p className="text-[18px]/8 text-textSecondary text-justify">
                        از اینکه از خرید خود راضی بودید بسیار خرسیندیم جناب آقای
                        مختاری
                    </p>
                </div>
            </div>
