                            ...
                            <table className="w-max min-w-max rounded-lg tablet:border">
                                <thead>
                                    <tr
                                        ...
                                        <th className="w-[7rem] py-4 border whitespace-nowrap">
                                            سایز (cm)
                                        </th>
                                        <th className="w-[7rem] py-4 border whitespace-nowrap">
                                            دور سینه (cm)
                                ...
                                <tbody>
                                    {sizeData.map((item, index) => (
                                        <tr
                                            key={index}
                                            className={`font-light ${index % 2 === 0 ? 'bg-gray-50' : ''}`}>
                                            <td className="w-[7rem] py-4 border text-center">
                                                {item.size}
                                            </td>
                                            <td className="w-[7rem] py-4 border text-center">
                                                {item.chest}
