...
function ProductNavbar() {
    ...
    return (
        <nav
            className={`flex px-4 py-5 fixed top-0 w-full bg-bgPrimary z-40 font-font items-center flex-row-reverse justify-between transition-transform duration-300
